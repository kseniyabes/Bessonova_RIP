...
# Отделы
orch = [
    orchectra(1, 'Симфонический оркестр'),
    orchectra(2, 'Духовой оркестр'),
    orchectra(3, 'Военный оркестр'),
 
    orchectra(11, 'Струнный оркестр'),
    orchectra(22, 'Оркестр народных инструментов'),
    orchectra(33, 'Эстрадный оркестр'),
]
 
# Сотрудники
emps = [
    Emp(1, 'Попов', 100000, 1),
    Emp(2, 'Пирогов', 25000, 2),
    Emp(3, 'Антонов', 45000, 1),
    Emp(4, 'Заречный', 35000, 3),
    Emp(5, 'Никифоров', 25000, 3),
]
